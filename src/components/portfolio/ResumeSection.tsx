...
export default function ResumeSection() {
  ...
  return (
    <section id="resume" className="relative px-5 py-14 sm:px-8 sm:py-16 md:px-10 md:py-20">
      <FadeIn>
        <h2
          className="hero-heading mb-10 text-center font-black uppercase leading-none tracking-tight sm:mb-12 md:mb-14"
      ...
      <FadeIn>
        <h2
          className="mb-10 mt-16 text-center font-black uppercase leading-none tracking-tight hero-heading sm:mb-12 md:mb-14 md:mt-20"
          style={{ fontSize: "clamp(2.6rem, 12vw, 160px)" }}
        >
          Education
        </h2>
