...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative flex flex-col items-center gap-8 bg-[#0C0C0C] px-5 py-16 sm:px-8 md:px-10 md:py-24"
    >
      <FadeIn>
        <h2
      ...
      <FadeIn delay={0.4}>
        <p className="pt-10 text-xs uppercase tracking-[0.3em] text-[#D7E2EA]/40">{footer}</p>
      </FadeIn>
    </section>
  );
}
